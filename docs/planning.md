...
Seed milestone plans live in `../plans/seed/`. Milestones 001 and 002 have created the runnable Go/Svelte foundation, local-token identity, bootstrap admin promotion, and room create/join flows.
